...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -3094.5088918246947; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 3058.431971004152; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2859.4993647517663; // x position of the perpendicular encoder (in tick units)
    }
